...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('package', models.CharField(choices=[('starter', 'Starter'), ('silver', 'Silver'), ('gold', 'Gold'), ('platinum', 'Platinum'), ('titanium', 'Titanium'), ('diamond', 'Diamond'), ('vip', 'VIP')], max_length=150)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('package', models.CharField(choices=[('basic', 'Basic'), ('standard', 'Standard'), ('royal', 'Royal')], max_length=150)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_package', models.DateField()),
                ('last_benefit_date', models.DateField(blank=True, default=django.utils.timezone.now, null=True)),
                ('invest_amount', models.BigIntegerField()),
                ('investment_package', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='dashboard.InvestmentPlans')),
                ('partnership_package', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='dashboard.PartnershipPlans')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
